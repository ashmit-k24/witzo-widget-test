...
interface SubscriptionUpgradedEmailTemplateParams {
	recipientEmail: string;
	planName: string;
}

interface SubscriptionUpgradedEmailTemplateResult {
	subject: string;
	html: string;
	text: string;
}
...
export function buildSubscriptionUpgradedEmailTemplate(
	params: SubscriptionUpgradedEmailTemplateParams,
): SubscriptionUpgradedEmailTemplateResult {
	...
	const subject = "Witzo Subscription Upgraded";
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Witzo Subscription Upgraded</title>
    <link
  ...
  <body style="margin:0; padding:0; background-color:#ffffff; font-family:'Inter', Arial, Helvetica, sans-serif;">
              ...
              <td style="padding:30px 28px 24px 28px; color:#0f172a; font-size:14px; line-height:1.7;">
               <p style="margin:0 0 16px 0; color:#111827; font-size:24px; line-height:1.25; font-weight:700;">
                ...
                <p style="margin:0 0 20px 0; color:#111827; font-size:14px;">
                  Your Witzo AI plan has been upgraded to <strong>${escapedPlanName}</strong>. Your new capabilities are live.
                </p>

                <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:20px 0 18px 0;">
                  <tr>
                    <td style="border:1px solid #d8b4fe; background-color:#fdf4ff; border-radius:12px; padding:12px 14px;">
                      <p style="margin:0 0 6px 0; color:#6b21a8; font-size:14px; font-weight:700;">
                        Active plan
                      </p>
	...
	const text = [
		"Witzo Subscription Upgraded",
		"",
		`Hi ${getDisplayNameFromEmail(recipientEmail)},`,
		`Your Witzo AI plan has been upgraded to ${planName}. Your new capabilities are live.`,
