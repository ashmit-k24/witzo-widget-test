...
export async function getUserSystemMessageSelectFields(
	...
	if (await hasUserSystemMessageColumns()) {
		return `, ${alias}.use_default_system_message, ${alias}.system_message_configured`;
	}

	return `, TRUE AS use_default_system_message, ${alias}.onboarding_completed AS system_message_configured`;
}
