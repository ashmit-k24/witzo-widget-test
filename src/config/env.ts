...
export const config: EnvConfig = {
	...
	SEMANTIC_ANSWER_CACHE_ENABLED: getEnvBoolean(
		"SEMANTIC_ANSWER_CACHE_ENABLED",
		true,
	),
	SEMANTIC_ANSWER_CACHE_THRESHOLD: getEnvNumber(
		"SEMANTIC_ANSWER_CACHE_THRESHOLD",
		0.88,
	),
	SEMANTIC_ANSWER_CACHE_MAX_ENTRIES: getEnvNumber(
		"SEMANTIC_ANSWER_CACHE_MAX_ENTRIES",
		50,
	),
