...
import { authenticateToken, clearCookies, setCookies } from '../middleware/auth';
...
router.post(
  ...
  validate,
  async (req: Request<{}, {}, RequestCodeBody>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
router.post(
  ...
  validate,
  async (req: Request<{}, {}, VerifyCodeBody>, res: Response, next: NextFunction): Promise<void> => {
    try {
